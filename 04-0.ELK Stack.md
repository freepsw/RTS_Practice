...
### check track(http_logs) file Size
```
> ls -alh ~/.rally/benchmarks/data/http_logs
1 freepsw freepsw  14M Nov 27 05:30 documents-181998.json.bz2
-rw-rw-r-- 1 freepsw freepsw  937 Nov 27 05:30 documents-181998.json.offset
-rw-rw-r-- 1 freepsw freepsw 1.3G Nov 27 05:32 documents-191998.json
-rw-rw-r-- 1 freepsw freepsw  48M Nov 27 05:30 documents-191998.json.bz2
-rw-rw-r-- 1 freepsw freepsw 3.5K Nov 27 05:32 documents-191998.json.offset
-rw-rw-r-- 1 freepsw freepsw 1.7G Nov 27 05:34 documents-201998.json
-rw-rw-r-- 1 freepsw freepsw  63M Nov 27 05:32 documents-201998.json.bz2
-rw-rw-r-- 1 freepsw freepsw 4.8K Nov 27 05:34 documents-201998.json.offset
-rw-rw-r-- 1 freepsw freepsw 2.3G Nov 27 05:36 documents-211998.json
-rw-rw-r-- 1 freepsw freepsw  85M Nov 27 05:34 documents-211998.json.bz2
-rw-rw-r-- 1 freepsw freepsw 6.5K Nov 27 05:37 documents-211998.json.offset
-rw-rw-r-- 1 freepsw freepsw 1.4G Nov 27 05:38 documents-221998.json
-rw-rw-r-- 1 freepsw freepsw  52M Nov 27 05:37 documents-221998.json.bz2
-rw-rw-r-- 1 freepsw freepsw 3.9K Nov 27 05:38 documents-221998.json.offset
-rw-rw-r-- 1 freepsw freepsw 1.5G Nov 27 05:40 documents-231998.json
-rw-rw-r-- 1 freepsw freepsw  59M Nov 27 05:38 documents-231998.json.bz2
-rw-rw-r-- 1 freepsw freepsw 4.3K Nov 27 05:40 documents-231998.json.offset
-rw-rw-r-- 1 freepsw freepsw  23G Nov 27 06:12 documents-241998.json
-rw-rw-r-- 1 freepsw freepsw 864M Nov 27 05:41 documents-241998.json.bz2
-rw-rw-r-- 1 freepsw freepsw  75K Nov 27 06:13 documents-241998.json.offset

> head documents-181998.json
...
## Start Benchmark
```
# index를 생성하고, 다양한 쿼리를 수행하는 옵션 (challenge)
> esrally --distribution-version=7.4.2 --track=http_logs  --challenge=append-no-conflicts  --pipeline=benchmark-only

# index를 생성하고 데이터를 추가하는 옵션 (challenge)
> esrally --distribution-version=7.4.2 --track=http_logs  --challenge=append-no-conflicts-index-only  --pipeline=benchmark-only
```
...
health status index       uuid                   pri rep docs.count docs.deleted store.size pri.store.size
green  open   logs-181998 jyViOgsYQACTOPWlm2HLPA   5   0    2708746            0    239.4mb        239.4mb

>  curl -XGET http://localhost:9200/_cat/shards
logs-181998 4 p STARTED 542879 47.4mb 127.0.0.1 freepsw-es
logs-181998 2 p STARTED 540510 47.6mb 127.0.0.1 freepsw-es
logs-181998 1 p STARTED 540627 47.6mb 127.0.0.1 freepsw-es
logs-181998 3 p STARTED 542236 48.6mb 127.0.0.1 freepsw-es
logs-181998 0 p STARTED 542494 47.9mb 127.0.0.1 freepsw-es
```
...
### Test Result
```
> esrally --distribution-version=7.4.2 --track=http_logs  --challenge=append-no-conflicts-index-only
|                                                         Metric |                                        Task |      Value |    Unit |
|---------------------------------------------------------------:|--------------------------------------------:|-----------:|--------:|
|                     Cumulative indexing time of primary shards |                                             |    94.4639 |     min |
|             Min cumulative indexing time across primary shards |                                             |     0.6577 |     min |
|          Median cumulative indexing time across primary shards |                                             |    2.86917 |     min |
|             Max cumulative indexing time across primary shards |                                             |    24.1993 |     min |
|            Cumulative indexing throttle time of primary shards |                                             |          0 |     min |
|    Min cumulative indexing throttle time across primary shards |                                             |          0 |     min |
| Median cumulative indexing throttle time across primary shards |                                             |          0 |     min |
|    Max cumulative indexing throttle time across primary shards |                                             |          0 |     min |
|                        Cumulative merge time of primary shards |                                             |    19.8509 |     min |
|                       Cumulative merge count of primary shards |                                             |        144 |         |
|                Min cumulative merge time across primary shards |                                             |    0.05245 |     min |
|             Median cumulative merge time across primary shards |                                             |    0.60675 |     min |
|                Max cumulative merge time across primary shards |                                             |    5.58138 |     min |
|               Cumulative merge throttle time of primary shards |                                             |    3.80497 |     min |
|       Min cumulative merge throttle time across primary shards |                                             |          0 |     min |
|    Median cumulative merge throttle time across primary shards |                                             |    0.04055 |     min |
|       Max cumulative merge throttle time across primary shards |                                             |    1.35445 |     min |
|                      Cumulative refresh time of primary shards |                                             |     2.0508 |     min |
|                     Cumulative refresh count of primary shards |                                             |        308 |         |
|              Min cumulative refresh time across primary shards |                                             |    0.06385 |     min |
|           Median cumulative refresh time across primary shards |                                             |  0.0837333 |     min |
|              Max cumulative refresh time across primary shards |                                             |   0.572217 |     min |
|                        Cumulative flush time of primary shards |                                             |    3.54708 |     min |
|                       Cumulative flush count of primary shards |                                             |         38 |         |
|                Min cumulative flush time across primary shards |                                             |          0 |     min |
|             Median cumulative flush time across primary shards |                                             |    0.06995 |     min |
|                Max cumulative flush time across primary shards |                                             |   0.975333 |     min |
|                                             Total Young Gen GC |                                             |      0.666 |       s |
|                                               Total Old Gen GC |                                             |          0 |       s |
|                                                     Store size |                                             |      6.412 |      GB |
|                                                  Translog size |                                             | 5.6345e-07 |      GB |
|                                         Heap used for segments |                                             |    26.7184 |      MB |
|                                       Heap used for doc values |                                             | 0.00149155 |      MB |
|                                            Heap used for terms |                                             |     23.219 |      MB |
|                                            Heap used for norms |                                             |  0.0010376 |      MB |
|                                           Heap used for points |                                             |    1.25166 |      MB |
|                                    Heap used for stored fields |                                             |    2.24523 |      MB |
|                                                  Segment count |                                             |         11 |         |
|                                                     error rate |                                index-append |          0 |       % |
|                                                 Min Throughput |                                     default |       8.01 |   ops/s |
|                                              Median Throughput |                                     default |       8.01 |   ops/s |
|                                                 Max Throughput |                                     default |       8.02 |   ops/s |
|                                        50th percentile latency |                                     default |     4.8856 |      ms |
|                                        90th percentile latency |                                     default |    5.47815 |      ms |
|                                        99th percentile latency |                                     default |    6.35672 |      ms |
|                                       100th percentile latency |                                     default |    9.07659 |      ms |
|                                   50th percentile service time |                                     default |    4.60596 |      ms |
|                                   90th percentile service time |                                     default |    5.18846 |      ms |
|                                   99th percentile service time |                                     default |    6.13137 |      ms |
|                                  100th percentile service time |                                     default |    8.80007 |      ms |
|                                                     error rate |                                     default |          0 |       % |
|                                                 Min Throughput |                                        term |      50.07 |   ops/s |
|                                              Median Throughput |                                        term |      50.07 |   ops/s |
|                                                 Max Throughput |                                        term |      50.08 |   ops/s |
|                                        50th percentile latency |                                        term |    4.88328 |      ms |
|                                        90th percentile latency |                                        term |    5.50206 |      ms |
|                                        99th percentile latency |                                        term |    5.83455 |      ms |
|                                       100th percentile latency |                                        term |    6.10564 |      ms |
|                                   50th percentile service time |                                        term |    4.70141 |      ms |
|                                   90th percentile service time |                                        term |    5.31015 |      ms |
|                                   99th percentile service time |                                        term |    5.65801 |      ms |
|                                  100th percentile service time |                                        term |    5.90882 |      ms |
|                                                     error rate |                                        term |          0 |       % |
|                                                 Min Throughput |                                       range |          1 |   ops/s |
|                                              Median Throughput |                                       range |       1.01 |   ops/s |
|                                                 Max Throughput |                                       range |       1.01 |   ops/s |
|                                        50th percentile latency |                                       range |    8.46619 |      ms |
|                                        90th percentile latency |                                       range |    9.44911 |      ms |
|                                        99th percentile latency |                                       range |    10.9625 |      ms |
|                                       100th percentile latency |                                       range |      11.45 |      ms |
|                                   50th percentile service time |                                       range |    7.34805 |      ms |
|                                   90th percentile service time |                                       range |    8.28021 |      ms |
|                                   99th percentile service time |                                       range |    9.82614 |      ms |
|                                  100th percentile service time |                                       range |    10.2902 |      ms |
|                                                     error rate |                                       range |          0 |       % |
|                                        50th percentile latency |                                  hourly_agg |    203.392 |      ms |
|                                        90th percentile latency |                                  hourly_agg |    212.669 |      ms |
|                                        99th percentile latency |                                  hourly_agg |    224.049 |      ms |
|                                       100th percentile latency |                                  hourly_agg |    224.435 |      ms |
|                                   50th percentile service time |                                  hourly_agg |     198.71 |      ms |
|                                   90th percentile service time |                                  hourly_agg |     207.73 |      ms |
|                                   99th percentile service time |                                  hourly_agg |    219.102 |      ms |
|                                  100th percentile service time |                                  hourly_agg |    219.521 |      ms |
|                                                     error rate |                                  hourly_agg |        100 |       % |
|                                                 Min Throughput |                                      scroll |      25.05 | pages/s |
|                                              Median Throughput |                                      scroll |      25.07 | pages/s |
|                                                 Max Throughput |                                      scroll |      25.14 | pages/s |
|                                        50th percentile latency |                                      scroll |    434.685 |      ms |
|                                        90th percentile latency |                                      scroll |    456.312 |      ms |
|                                        99th percentile latency |                                      scroll |    487.835 |      ms |
|                                       100th percentile latency |                                      scroll |    490.383 |      ms |
|                                   50th percentile service time |                                      scroll |     433.91 |      ms |
|                                   90th percentile service time |                                      scroll |    455.509 |      ms |
|                                   99th percentile service time |                                      scroll |    487.108 |      ms |
|                                  100th percentile service time |                                      scroll |    489.541 |      ms |
|                                                     error rate |                                      scroll |          0 |       % |
...
|                                        50th percentile latency |                         desc_sort_timestamp |    593.772 |      ms |
|                                        90th percentile latency |                         desc_sort_timestamp |    624.281 |      ms |
|                                        99th percentile latency |                         desc_sort_timestamp |    645.387 |      ms |
|                                       100th percentile latency |                         desc_sort_timestamp |    648.727 |      ms |
|                                   50th percentile service time |                         desc_sort_timestamp |    592.204 |      ms |
|                                   90th percentile service time |                         desc_sort_timestamp |    622.728 |      ms |
|                                   99th percentile service time |                         desc_sort_timestamp |    643.873 |      ms |
|                                  100th percentile service time |                         desc_sort_timestamp |    647.169 |      ms |
...
|                                        50th percentile latency |                          asc_sort_timestamp |    573.326 |      ms |
|                                        90th percentile latency |                          asc_sort_timestamp |    594.604 |      ms |
|                                        99th percentile latency |                          asc_sort_timestamp |    607.873 |      ms |
|                                       100th percentile latency |                          asc_sort_timestamp |    621.429 |      ms |
|                                   50th percentile service time |                          asc_sort_timestamp |    571.744 |      ms |
|                                   90th percentile service time |                          asc_sort_timestamp |    592.925 |      ms |
|                                   99th percentile service time |                          asc_sort_timestamp |    606.219 |      ms |
|                                  100th percentile service time |                          asc_sort_timestamp |    619.832 |      ms |
...
|                                        50th percentile latency | desc-sort-timestamp-after-force-merge-1-seg |    605.045 |      ms |
|                                        90th percentile latency | desc-sort-timestamp-after-force-merge-1-seg |     636.92 |      ms |
|                                        99th percentile latency | desc-sort-timestamp-after-force-merge-1-seg |    748.762 |      ms |
|                                       100th percentile latency | desc-sort-timestamp-after-force-merge-1-seg |    852.252 |      ms |
|                                   50th percentile service time | desc-sort-timestamp-after-force-merge-1-seg |    603.511 |      ms |
|                                   90th percentile service time | desc-sort-timestamp-after-force-merge-1-seg |    635.368 |      ms |
|                                   99th percentile service time | desc-sort-timestamp-after-force-merge-1-seg |    747.217 |      ms |
|                                  100th percentile service time | desc-sort-timestamp-after-force-merge-1-seg |    850.629 |      ms |
...
|                                        50th percentile latency |  asc-sort-timestamp-after-force-merge-1-seg |    571.627 |      ms |
|                                        90th percentile latency |  asc-sort-timestamp-after-force-merge-1-seg |    587.283 |      ms |
|                                        99th percentile latency |  asc-sort-timestamp-after-force-merge-1-seg |    701.592 |      ms |
|                                       100th percentile latency |  asc-sort-timestamp-after-force-merge-1-seg |    711.883 |      ms |
|                                   50th percentile service time |  asc-sort-timestamp-after-force-merge-1-seg |    570.037 |      ms |
|                                   90th percentile service time |  asc-sort-timestamp-after-force-merge-1-seg |    585.715 |      ms |
|                                   99th percentile service time |  asc-sort-timestamp-after-force-merge-1-seg |     700.01 |      ms |
|                                  100th percentile service time |  asc-sort-timestamp-after-force-merge-1-seg |    710.383 |      ms |
...
[WARNING] No throughput metrics available for [hourly_agg]. Likely cause: Error rate is 100.0%. Please check the logs.
```



### TEST 1. Rally index-only Test
#### Rally Configuration
##### track.json
- 테스트할 데이터를 정의하는 설정 파일. (사전에 건수 및 사이즈를 입력하면, 테스트 속도가 빨라짐.)
```json
{
  "version": 2,
...
- 실제 테스트를 실행할 명령어 관련 설정을 조정한다.
- 유형별 테스트 명령어 지정 및 warmup time, warm iteration 등 다양한 옵션 변경
```json
{
  "name": "append-no-conflicts",
  "description": "Indexes the whole document corpus using Elasticsearch default settings. We only adjust the number of replicas as we benchmark a single node cluster and Rally will only start the benchmark if the cluster turns green. Document ids are unique so all index operations are append only. After that a couple of queries are run.",
...
|                                                         Metric |         Task |       Value |   Unit |
|---------------------------------------------------------------:|-------------:|------------:|-------:|
|                     Cumulative indexing time of primary shards |              |     32.4143 |    min |
|             Min cumulative indexing time across primary shards |              |    0.805533 |    min |
|          Median cumulative indexing time across primary shards |              |     2.48087 |    min |
|             Max cumulative indexing time across primary shards |              |      3.3802 |    min |
|            Cumulative indexing throttle time of primary shards |              |           0 |    min |
|    Min cumulative indexing throttle time across primary shards |              |           0 |    min |
| Median cumulative indexing throttle time across primary shards |              |           0 |    min |
|    Max cumulative indexing throttle time across primary shards |              |           0 |    min |
|                        Cumulative merge time of primary shards |              |    0.391317 |    min |
|                       Cumulative merge count of primary shards |              |          20 |        |
|                Min cumulative merge time across primary shards |              |           0 |    min |
|             Median cumulative merge time across primary shards |              |           0 |    min |
|                Max cumulative merge time across primary shards |              |     0.08565 |    min |
|               Cumulative merge throttle time of primary shards |              |           0 |    min |
|       Min cumulative merge throttle time across primary shards |              |           0 |    min |
|    Median cumulative merge throttle time across primary shards |              |           0 |    min |
|       Max cumulative merge throttle time across primary shards |              |           0 |    min |
|                      Cumulative refresh time of primary shards |              |      2.7786 |    min |
|                     Cumulative refresh count of primary shards |              |         113 |        |
|              Min cumulative refresh time across primary shards |              |      0.0415 |    min |
|           Median cumulative refresh time across primary shards |              |    0.253883 |    min |
|              Max cumulative refresh time across primary shards |              |     0.34845 |    min |
|                        Cumulative flush time of primary shards |              |           0 |    min |
|                       Cumulative flush count of primary shards |              |           0 |        |
|                Min cumulative flush time across primary shards |              |           0 |    min |
|             Median cumulative flush time across primary shards |              |           0 |    min |
|                Max cumulative flush time across primary shards |              |           0 |    min |
|                                             Total Young Gen GC |              |       1.269 |      s |
|                                               Total Old Gen GC |              |           0 |      s |
|                                                     Store size |              |     2.26752 |     GB |
|                                                  Translog size |              | 7.68341e-07 |     GB |
|                                         Heap used for segments |              |     5.34385 |     MB |
|                                       Heap used for doc values |              |   0.0156937 |     MB |
|                                            Heap used for terms |              |       3.937 |     MB |
|                                            Heap used for norms |              |  0.00646973 |     MB |
|                                           Heap used for points |              |    0.625975 |     MB |
|                                    Heap used for stored fields |              |    0.758713 |     MB |
|                                                  Segment count |              |         106 |        |
|                                                 Min Throughput | index-append |      148496 | docs/s |
|                                              Median Throughput | index-append |      168774 | docs/s |
|                                                 Max Throughput | index-append |      173090 | docs/s |
|                                        50th percentile latency | index-append |     187.737 |     ms |
|                                        90th percentile latency | index-append |     258.693 |     ms |
|                                        99th percentile latency | index-append |     1002.75 |     ms |
|                                      99.9th percentile latency | index-append |     3546.67 |     ms |
|                                       100th percentile latency | index-append |     4970.06 |     ms |
|                                   50th percentile service time | index-append |     187.737 |     ms |
|                                   90th percentile service time | index-append |     258.693 |     ms |
|                                   99th percentile service time | index-append |     1002.75 |     ms |
|                                 99.9th percentile service time | index-append |     3546.67 |     ms |
|                                  100th percentile service time | index-append |     4970.06 |     ms |
|                                                     error rate | index-append |           0 |      % |


---------------------------------
[INFO] SUCCESS (took 233 seconds)
---------------------------------
```
...
> curl -XGET http://localhost:9200/_cat/indices?v
health status index       uuid                   pri rep docs.count docs.deleted store.size pri.store.size
green  open   logs-181998 i-5WKlBzSJSPjMc1NSQdWw   5   0    2708746            0    239.6mb        239.6mb
green  open   logs-201998 y9N1Rji0SW2Od9HvSW5vQg   5   0   13053463            0      1.1gb          1.1gb
green  open   logs-191998 jtvC0m2jSnaSPdSpSnwBUA   5   0    9697882            0    896.6mb        896.6mb

> curl -XGET http://localhost:9200/_cat/shards
logs-181998 4 p STARTED  542220  48.5mb 127.0.0.1 freepsw-es
logs-181998 1 p STARTED  541090  47.4mb 127.0.0.1 freepsw-es
logs-181998 2 p STARTED  541615  48.2mb 127.0.0.1 freepsw-es
logs-181998 3 p STARTED  542130    48mb 127.0.0.1 freepsw-es
logs-181998 0 p STARTED  541691  47.3mb 127.0.0.1 freepsw-es
logs-201998 4 p STARTED 2607322 236.1mb 127.0.0.1 freepsw-es
logs-201998 1 p STARTED 2613038 238.5mb 127.0.0.1 freepsw-es
logs-201998 2 p STARTED 2608374 236.7mb 127.0.0.1 freepsw-es
logs-201998 3 p STARTED 2614201 237.3mb 127.0.0.1 freepsw-es
logs-201998 0 p STARTED 2610528 236.8mb 127.0.0.1 freepsw-es
logs-191998 4 p STARTED 1939249 178.9mb 127.0.0.1 freepsw-es
logs-191998 1 p STARTED 1939290 179.5mb 127.0.0.1 freepsw-es
logs-191998 2 p STARTED 1940057 179.2mb 127.0.0.1 freepsw-es
logs-191998 3 p STARTED 1940676 179.5mb 127.0.0.1 freepsw-es
logs-191998 0 p STARTED 1938610 179.3mb 127.0.0.1 freepsw-es

```


### TEST 2. Rally GEONAMES index-only Test
#### Rally Configuration
- default.json
...
#### Run Test
```
> esrally --distribution-version=7.4.2 --track=geonames  --challenge=append-no-conflicts-index-only  --pipeline=benchmark-only
|                                                         Metric |         Task |     Value |   Unit |
|---------------------------------------------------------------:|-------------:|----------:|-------:|
|                     Cumulative indexing time of primary shards |              |   39.0722 |    min |
|             Min cumulative indexing time across primary shards |              |   7.66602 |    min |
|          Median cumulative indexing time across primary shards |              |   7.84447 |    min |
|             Max cumulative indexing time across primary shards |              |   7.89555 |    min |
|            Cumulative indexing throttle time of primary shards |              |         0 |    min |
|    Min cumulative indexing throttle time across primary shards |              |         0 |    min |
| Median cumulative indexing throttle time across primary shards |              |         0 |    min |
|    Max cumulative indexing throttle time across primary shards |              |         0 |    min |
|                        Cumulative merge time of primary shards |              |  0.765533 |    min |
|                       Cumulative merge count of primary shards |              |         7 |        |
|                Min cumulative merge time across primary shards |              |   0.05095 |    min |
|             Median cumulative merge time across primary shards |              |  0.156033 |    min |
|                Max cumulative merge time across primary shards |              |  0.214767 |    min |
|               Cumulative merge throttle time of primary shards |              | 0.0751833 |    min |
|       Min cumulative merge throttle time across primary shards |              |         0 |    min |
|    Median cumulative merge throttle time across primary shards |              | 0.0173333 |    min |
|       Max cumulative merge throttle time across primary shards |              |    0.0234 |    min |
|                      Cumulative refresh time of primary shards |              |  0.514967 |    min |
|                     Cumulative refresh count of primary shards |              |        33 |        |
|              Min cumulative refresh time across primary shards |              | 0.0700167 |    min |
|           Median cumulative refresh time across primary shards |              | 0.0766167 |    min |
|              Max cumulative refresh time across primary shards |              |    0.2147 |    min |
|                        Cumulative flush time of primary shards |              |   1.94703 |    min |
|                       Cumulative flush count of primary shards |              |         5 |        |
|                Min cumulative flush time across primary shards |              |  0.130417 |    min |
|             Median cumulative flush time across primary shards |              |  0.443567 |    min |
|                Max cumulative flush time across primary shards |              |  0.467267 |    min |
|                                             Total Young Gen GC |              |     1.542 |      s |
|                                               Total Old Gen GC |              |         0 |      s |
|                                                     Store size |              |   3.42114 |     GB |
|                                                  Translog size |              |  0.985099 |     GB |
|                                         Heap used for segments |              |   3.75078 |     MB |
|                                       Heap used for doc values |              | 0.0683441 |     MB |
|                                            Heap used for terms |              |   2.62933 |     MB |
|                                            Heap used for norms |              |  0.134705 |     MB |
|                                           Heap used for points |              |  0.238317 |     MB |
|                                    Heap used for stored fields |              |  0.680084 |     MB |
|                                                  Segment count |              |       170 |        |
|                                                 Min Throughput | index-append |   67849.8 | docs/s |
|                                              Median Throughput | index-append |   71388.2 | docs/s |
|                                                 Max Throughput | index-append |   72828.1 | docs/s |
|                                        50th percentile latency | index-append |   342.448 |     ms |
|                                        90th percentile latency | index-append |   433.107 |     ms |
|                                        99th percentile latency | index-append |   2043.08 |     ms |
|                                       100th percentile latency | index-append |    2671.1 |     ms |
|                                   50th percentile service time | index-append |   342.448 |     ms |
|                                   90th percentile service time | index-append |   433.107 |     ms |
|                                   99th percentile service time | index-append |   2043.08 |     ms |
|                                  100th percentile service time | index-append |    2671.1 |     ms |
|                                                     error rate | index-append |         0 |      % |

---------------------------------
[INFO] SUCCESS (took 252 seconds)
---------------------------------
```


### TEST 2. Rally EventData index-only Test
#### Rally Configuration
- default.json
...
#### Test Data
```
{"agent": "\"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.87 Safari/537.36\"", "useragent": {"os": "Mac OS X 10.11.4", "os_name": "Mac OS X", "name": "Chrome"}, "geoip": {"country_name": "China", "location": [114.13330000000002, 22.533299999999997]}, "clientip": "210.21.236.0", "referrer": "\"https://www.elastic.co/guide/en/elasticsearch/guide/current/mapping-intro.html\"", "request": "/products/logstash", "bytes": 0, "verb": "GET", "response": 304, "httpversion": "1.1", "@timestamp": "2017-07-03T07:51:49.994Z", "message": "210.21.236.0 - - [2017-07-03T07:51:49.994Z] \"GET /products/logstash HTTP/1.1\" 304 0 \"-\" \"https://www.elastic.co/guide/en/elasticsearch/guide/current/mapping-intro.html\" \"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2623.87 Safari/537.36\""}
```
...
#### Run Test
```
esrally --distribution-version=7.4.2 --track=eventdata  --challenge=append-no-conflicts  --pipeline=benchmark-only
|                                                         Metric |         Task |       Value |   Unit |
|---------------------------------------------------------------:|-------------:|------------:|-------:|
|                     Cumulative indexing time of primary shards |              |     81.6234 |    min |
|             Min cumulative indexing time across primary shards |              |     15.8412 |    min |
|          Median cumulative indexing time across primary shards |              |     16.3418 |    min |
|             Max cumulative indexing time across primary shards |              |     16.6126 |    min |
|            Cumulative indexing throttle time of primary shards |              |           0 |    min |
|    Min cumulative indexing throttle time across primary shards |              |           0 |    min |
| Median cumulative indexing throttle time across primary shards |              |           0 |    min |
|    Max cumulative indexing throttle time across primary shards |              |           0 |    min |
|                        Cumulative merge time of primary shards |              |     8.39333 |    min |
|                       Cumulative merge count of primary shards |              |          54 |        |
|                Min cumulative merge time across primary shards |              |     1.52293 |    min |
|             Median cumulative merge time across primary shards |              |     1.59135 |    min |
|                Max cumulative merge time across primary shards |              |     1.90995 |    min |
|    Min cumulative indexing throttle time across primary shards |              |           0 |    min |
| Median cumulative indexing throttle time across primary shards |              |           0 |    min |
|    Max cumulative indexing throttle time across primary shards |              |           0 |    min |
|                        Cumulative merge time of primary shards |              |     8.39333 |    min |
...
|             Median cumulative merge time across primary shards |              |     1.59135 |    min |
|                Max cumulative merge time across primary shards |              |     1.90995 |    min |
|               Cumulative merge throttle time of primary shards |              |     2.68313 |    min |
|       Min cumulative merge throttle time across primary shards |              |    0.455433 |    min |
|    Median cumulative merge throttle time across primary shards |              |    0.497283 |    min |
|       Max cumulative merge throttle time across primary shards |              |    0.692383 |    min |
|                      Cumulative refresh time of primary shards |              |    0.465317 |    min |
|                     Cumulative refresh count of primary shards |              |          82 |        |
|              Min cumulative refresh time across primary shards |              |   0.0883833 |    min |
|           Median cumulative refresh time across primary shards |              |   0.0905333 |    min |
|              Max cumulative refresh time across primary shards |              |    0.102583 |    min |
|                        Cumulative flush time of primary shards |              |     5.19657 |    min |
|                       Cumulative flush count of primary shards |              |          30 |        |
|                Min cumulative flush time across primary shards |              |    0.982683 |    min |
|             Median cumulative flush time across primary shards |              |     1.04672 |    min |
|                Max cumulative flush time across primary shards |              |     1.09235 |    min |
|                                             Total Young Gen GC |              |       0.913 |      s |
|                                               Total Old Gen GC |              |           0 |      s |
|                                                     Store size |              |     6.65101 |     GB |
|                                                  Translog size |              | 2.56114e-07 |     GB |
|                                         Heap used for segments |              |      9.6788 |     MB |
|                                       Heap used for doc values |              |   0.0645981 |     MB |
|                                            Heap used for terms |              |     6.25536 |     MB |
|                                            Heap used for norms |              |           0 |     MB |
|                                           Heap used for points |              |    0.647079 |     MB |
|                                    Heap used for stored fields |              |     2.71176 |     MB |
|                                                  Segment count |              |         202 |        |
|                                                 Min Throughput | index-append |     55356.1 | docs/s |
|                                              Median Throughput | index-append |     60083.3 | docs/s |
|                                                 Max Throughput | index-append |     67293.5 | docs/s |
|                                        50th percentile latency | index-append |     438.396 |     ms |
|                                        90th percentile latency | index-append |     1388.37 |     ms |
|                                        99th percentile latency | index-append |     3292.43 |     ms |
|                                      99.9th percentile latency | index-append |     4507.25 |     ms |
|                                       100th percentile latency | index-append |     4817.51 |     ms |
|                                   50th percentile service time | index-append |     438.396 |     ms |
|                                   90th percentile service time | index-append |     1388.37 |     ms |
|                                   99th percentile service time | index-append |     3292.43 |     ms |
|                                 99.9th percentile service time | index-append |     4507.25 |     ms |
|                                  100th percentile service time | index-append |     4817.51 |     ms |
|                                                     error rate | index-append |           0 |      % |


----------------------------------
[INFO] SUCCESS (took 2141 seconds)
----------------------------------
```
